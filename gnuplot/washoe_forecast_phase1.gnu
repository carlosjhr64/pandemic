...
plot \
  ...
  'cache/washoe/0-84_16_100.run'    using (f($1,31)):2 with lines              lc 'blue'   title 'D:22, T:16, C:100'  axis x1y2,\
  'cache/washoe/phase1_250_133.run' using (f($1,31)):2 with lines              lc 'pink'   title 'D:42, T:250, C:133' axis x1y2,\
  'cache/washoe/phase1_250_90.run'  using (f($1,31)):2 with lines              lc 'pink'   title 'D:42, T:250, C:90'  axis x1y2,\
  'cache/washoe/phase1_16_100.run'  using (f($1,31)):2 with lines              lc 'pink'   title 'D:42, T:16, C:100'  axis x1y2,\
